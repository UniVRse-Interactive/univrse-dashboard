...
export default function ClientOverviewPage() {
  return (
    <div className="space-y-8">
      <div><h1 className="text-2xl font-bold text-white">Overview</h1><p className="text-sm text-zinc-400">UniVRse client operations at a glance</p></div>
      ...
      <Card><CardHeader><CardTitle>Welcome to UniVRse</CardTitle></CardHeader><CardContent><p className="text-sm text-zinc-400">Connect to Supabase to populate live data. API endpoints at <code className="rounded bg-zinc-800 px-1.5 py-0.5 text-xs">/api/*</code></p></CardContent></Card>
    </div>
  )
}
